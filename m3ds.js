...
*/
	...
	center: [
		...
		},
		{
			color: 0,
			points: [
				[-((1 - M[1]) + 0.3827 * M[1]), -1.00, +((1 - M[1]) + 0.9239 * M[1])], [-((1 - M[1]) + 0.7071 * M[1]), -1.00, +((1 - M[1]) + 0.7071 * M[1])], [-((1 - M[1]) + 0.9239 * M[1]), -1.00, +((1 - M[1]) + 0.3827 * M[1])], [-(1), -1.00, +(1 - M[1])], [-(1), -1.00, -(1 - M[1])],
				[-((1 - M[1]) + 0.9239 * M[1]), -1.00, -((1 - M[1]) + 0.3827 * M[1])], [-((1 - M[1]) + 0.7071 * M[1]), -1.00, -((1 - M[1]) + 0.7071 * M[1])], [-((1 - M[1]) + 0.3827 * M[1]), -1.00, -((1 - M[1]) + 0.9239 * M[1])], [-(1 - M[1]), -1.00, -(1)], [+(1 - M[1]), -1.00, -(1)],
				[+((1 - M[1]) + 0.3827 * M[1]), -1.00, -((1 - M[1]) + 0.9239 * M[1])], [+((1 - M[1]) + 0.7071 * M[1]), -1.00, -((1 - M[1]) + 0.7071 * M[1])], [+((1 - M[1]) + 0.9239 * M[1]), -1.00, -((1 - M[1]) + 0.3827 * M[1])], [+(1), -1.00, -(1 - M[1])], [+(1), -1.00, +(1 - M[1])],
				[+((1 - M[1]) + 0.9239 * M[1]), -1.00, +((1 - M[1]) + 0.3827 * M[1])], [+((1 - M[1]) + 0.7071 * M[1]), -1.00, +((1 - M[1]) + 0.7071 * M[1])], [+((1 - M[1]) + 0.3827 * M[1]), -1.00, +((1 - M[1]) + 0.9239 * M[1])], [+(1 - M[1]), -1.00, +(1)], [-(1 - M[1]), -1.00, +(1)]
			]
		},
